...
/**
 * This is used in the STV voting to get absolute accuracy.
 * 
...
public class BigFraction implements Cloneable, Comparable, Serializable
{
    ...
    {
        this( new BigInteger( s.substring( 0, s.indexOf( '/' ) ) ), new BigInteger( s.substring( s.indexOf( '/' ) + 1 ) ) );
    }
    ...
    public static void main(String[] args)
    {
        ...
        // Start out with a big fraction whose numerator is 3 followed by 500
        // zeros
